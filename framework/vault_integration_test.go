...
func TestAccVaultDataSource_basic(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		ProtoV6ProviderFactories: protoV6ProviderFactories(runAnsibleVaultView),
...
func TestAccVaultStringDataSource_basic(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		ProtoV6ProviderFactories: protoV6ProviderFactories(runAnsibleVaultDecrypt),
		Steps: []resource.TestStep{
			{
				Config: fmt.Sprintf(`
...
func TestAccRunAnsibleVaultDecrypt_basic(t *testing.T) {
	...
	plaintext, diags := runAnsibleVaultDecrypt(context.Background(), passFile, "", encrypted)
...
func TestAccRunAnsibleVaultDecrypt_withVaultID(t *testing.T) {
	...
	plaintext, diags := runAnsibleVaultDecrypt(context.Background(), passFile, integrationVaultID, encrypted)
	require.False(t, diags.HasError())
	assert.Equal(t, integrationPlaintext, plaintext)
	assert.NotContains(t, plaintext, "Decryption successful")
}
...
func TestAccRunAnsibleVaultDecrypt_wrongPassword(t *testing.T) {
	...
	_, diags := runAnsibleVaultDecrypt(context.Background(), wrongPass, "", encrypted)
...
func TestAccRunAnsibleVaultView_basic(t *testing.T) {
	...
	plaintext, diags := runAnsibleVaultView(context.Background(), passFile, "", vaultFile)
	require.False(t, diags.HasError())
	assert.Equal(t, integrationPlaintext, plaintext)
}
...
func TestAccRunAnsibleVaultView_withVaultID(t *testing.T) {
	...
	plaintext, diags := runAnsibleVaultView(context.Background(), passFile, integrationVaultID, vaultFile)
	require.False(t, diags.HasError())
	assert.Equal(t, integrationPlaintext, plaintext)
}
...
func TestAccRunAnsibleVaultView_wrongPassword(t *testing.T) {
	...
	_, diags := runAnsibleVaultView(context.Background(), wrongPass, "", vaultFile)
	require.True(t, diags.HasError())
